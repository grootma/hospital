...
public class CommonUtils {
     ...
     * @return
     */
    public static Date getMonthEndPrevious() {
     ...
     * @return
     */
    public static Date getMonthEndCurrent() {
        Calendar lastDate = Calendar.getInstance();
        lastDate.set(Calendar.DATE, 1);
        lastDate.add(Calendar.MONTH, 1);
	 ...
	 * @param
	 * @param
		map.put("nickname", "wsliulei");
		testAction("http://127.0.0.1:8080/webapp/user/name_validate.action", map);
	 */
//	public static void testAction(String url, Map<String, Object> map) {
...
//		for (String key : keys) {
//			method.setParameter(key, map.get(key).toString());
//		}
//
//		try {
//			// 执行getMethod
...
//		map.put("3", "value3");
//		
//		List<String> allLabelList = new ArrayList<String>();
//		allLabelList.addAll(map.keySet());
//		
		
		
		
		System.out.println("--------");
		System.out.println(inet_aton("192.0.2.235")); 
	}
